        ...
        <div className="">
            {
                admin ?
                    ...
                    <div>
                        <Navbar />
                        <div className='d-flex justify-content-between p-2 mt-5 container ' style={{ backgroundColor: 'rgb(93, 137, 137)' }}>
                    ...
                    <div className='d-flex justify-content-between p-2 container mt-5' style={{ backgroundColor: 'rgb(93, 137, 137)' }}>
                        <div className='d-flex flex-wrap mx-auto'>
